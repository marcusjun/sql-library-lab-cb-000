...
INSERT INTO books (title, year, series_id) VALUES ("Shadowlands", 1999, 1), ("Tundralands", 2000, 1), ("Cloudlands", 2001, 1);
...
("Show The", "rogue", "Backstab or frontstab.", 2, 2), ("First Six", "oragle", "I see the future.", 2, 2), ("First Remark", "driver", "The cavalry is here.", 2, 2), ("Sense Of", "tactician", "Strategy wins battles", 2, 2);